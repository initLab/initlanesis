...
class zp_flickr_widget extends WP_Widget {
	...
	function ZP_FLICKR_Widget() {
		...
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'zp_flickr_widget', 'description' => __('A widget that displays your Flickr photos.', 'initlanesis') );

		/* Widget control settings. */
		//$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => '_ad_widget' );

		/* Create the widget. */
		$this->WP_Widget( 'zp_flickr_widget', __('ZP Flickr Photos', 'initlanesis'), $widget_ops);
	}
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'flickrID' ); ?>"><?php _e('Flickr ID:', 'initlanesis') ?> (<a href="http://idgettr.com/">idGettr</a>)</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'postcount' ); ?>"><?php _e('Number of Photos:', 'initlanesis') ?></label>
		...
		<!-- Type: Select Box -->
		<p>
			<label for="<?php echo $this->get_field_id( 'type' ); ?>"><?php _e('Type (user or group):', 'initlanesis') ?></label>
		...
		<!-- Display: Select Box -->
		<p>
			<label for="<?php echo $this->get_field_id( 'display' ); ?>"><?php _e('Display (random or latest):', 'initlanesis') ?></label>
