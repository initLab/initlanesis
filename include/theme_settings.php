...
function zpsettings_default_theme_options() {
	$options = array(
		'zp_welcome_enable' => 1,
		'zp_welcome_message' => __( 'This is the welcome message section','initlanesis' ),
		'zp_front_enable' => 1,
		...
		'zp_related_portfolio_title' => __( 'Related Portfolio','initlanesis' ),
...
function zpsettings_theme_settings_notice() {
	...
	if ( isset( $_REQUEST['reset'] ) && 'true' == $_REQUEST['reset'] )
		echo '<div id="message" class="updated"><p><strong>' . __( 'Settings reset.', 'initlanesis' ) . '</strong></p></div>';
	elseif ( isset( $_REQUEST['settings-updated'] ) && 'true' == $_REQUEST['settings-updated'] )
		echo '<div id="message" class="updated"><p><strong>' . __( 'Settings saved.', 'initlanesis' ) . '</strong></p></div>';
}
...
function zpsettings_theme_options() {
	...
	$_zpsettings_settings_pagehook = add_submenu_page( 'genesis', 'initlanesis Settings', 'initlanesis Settings', 'edit_theme_options', ZP_SETTINGS_FIELD, 'zpsettings_theme_options_page' );
...
function zpsettings_settings_boxes() {
	...
	add_meta_box( 'zpsettings_appearance_settings', __( 'Appearance Settings', 'initlanesis' ), 'zpsettings_appearance_settings', $_zpsettings_settings_pagehook, 'main' ,'high');
	add_meta_box( 'zpsettings_portfolio', __( 'Portfolio Settings ', 'initlanesis' ), 'zpsettings_portfolio', $_zpsettings_settings_pagehook, 'main','high' );
	add_meta_box( 'zpsettings_footer_settings', __( 'Footer Settings', 'initlanesis' ), 'zpsettings_footer_settings', $_zpsettings_settings_pagehook, 'main','high' );
	add_meta_box( 'zpsettings_responsive_logo_settings', __( 'Responsive Logo Settings', 'initlanesis' ), 'zpsettings_responsive_logo_settings', $_zpsettings_settings_pagehook, 'main' ,'high');
}
...
function zpsettings_appearance_settings() { ?>
  <p>
	...
	<label for="<?php echo ZP_SETTINGS_FIELD; ?>[zp_color_scheme]"><?php _e( 'Select color scheme.','initlanesis'); ?></label>
    ...
    <p><label for="<?php echo ZP_SETTINGS_FIELD; ?>[zp_css_code]"><?php _e( 'Custom CSS Code.', 'initlanesis' ); ?><br>
    ...
    <p><label for="<?php echo ZP_SETTINGS_FIELD; ?>[zp_logo]"><?php _e( 'Upload Custom Logo.', 'initlanesis' ); ?></label>
    ...
    <input id="<?php echo ZP_SETTINGS_FIELD; ?>[zp_logo_upload_button]" name="<?php echo ZP_SETTINGS_FIELD; ?>[zp_logo_upload_button]" type="button" class="logo_button button" value="<?php _e( 'Upload Logo', 'initlanesis' ); ?>" />
    ...
    <p><label for="<?php echo ZP_SETTINGS_FIELD; ?>[zp_logo_height]"><?php _e( 'Custom Logo Height in pixel/percentage.', 'initlanesis' ); ?></label>
    ...
    <p><label for="<?php echo ZP_SETTINGS_FIELD; ?>[zp_logo_width]"><?php _e( 'Custom Logo Width in pixel/percentage.', 'initlanesis' ); ?></label>
	...
	<input type="text" size="20" value="<?php echo genesis_get_option( 'zp_logo_width', ZP_SETTINGS_FIELD ); ?>" id="<?php echo ZP_SETTINGS_FIELD; ?>[zp_logo_width]" name="<?php echo ZP_SETTINGS_FIELD; ?>[zp_logo_width]">
 	...
 	<p> <label for="<?php echo ZP_SETTINGS_FIELD; ?>[zp_logo_background_pos]"><?php _e( 'Select Logo Position.','initlanesis'); ?></label>
    ...
    <p><label for="<?php echo ZP_SETTINGS_FIELD; ?>[zp_favicon]"><?php _e( 'Upload Custom Favicon.', 'initlanesis' ); ?></label>
    ...
    <input id="<?php echo ZP_SETTINGS_FIELD; ?>[zp_favicon_upload_button]" name="<?php echo ZP_SETTINGS_FIELD; ?>[zp_favicon_upload_button]" type="button" class="button" value="<?php _e( 'Upload Favicon', 'initlanesis' ); ?>" />
	...
	<p><span class="description"><?php _e( 'This is the appearance settings.','initlanesis' ); ?></span></p>
...
function zpsettings_footer_settings() { ?>
    ...
    <p><label for="<?php echo ZP_SETTINGS_FIELD; ?>[zp_footer_text]"><?php _e( 'Footer Text', 'initlanesis' ); ?><br>
	...
	<br><small><strong><?php _e( 'Enter your site copyright here.', 'initlanesis' ); ?></strong></small>
...
function zpsettings_portfolio() { ?>
    ...
    <p>	<input type="checkbox" name="<?php echo ZP_SETTINGS_FIELD; ?>[zp_related_portfolio]" id="<?php echo ZP_SETTINGS_FIELD; ?>[zp_related_portfolio]" value="1" <?php checked( 1, genesis_get_option( 'zp_related_portfolio', ZP_SETTINGS_FIELD ) ); ?> /> <label for="<?php echo ZP_SETTINGS_FIELD; ?>[zp_related_portfolio]"><?php _e( 'Check to enable related portfolio in single portfolio page.', 'initlanesis' ); ?></label>
     ...
     <p><label for="<?php echo ZP_SETTINGS_FIELD; ?>[zp_num_portfolio_items]"><?php _e( 'Number of items in the portfolio page', 'initlanesis' ) ?></label>
     ...
     <p><label for="<?php echo ZP_SETTINGS_FIELD; ?>[zp_num_archive_items]"><?php _e( 'Number of items in the portfolio archive', 'initlanesis' ) ?></label>
     ...
     <p><label for="<?php echo ZP_SETTINGS_FIELD; ?>[zp_portfolio_archive_columns]"><?php _e( 'Portfolio Archive Columns:','initlanesis' );?></label>
	...
	<option  value="3" <?php selected( genesis_get_option( 'zp_portfolio_archive_columns', ZP_SETTINGS_FIELD ), '3' ); ?>>Three Columns</option>
     ...
     <p><label for="<?php echo ZP_SETTINGS_FIELD; ?>[zp_portfolio_animation]"><?php _e( 'Portfolio Animations:','initlanesis' );?></label>
    ...
    <option  value="front_row" <?php selected( genesis_get_option( 'zp_portfolio_animation', ZP_SETTINGS_FIELD ), 'front_row' ); ?>>Front Row</option>
     ...
     <p><span class="description"><?php _e( 'This settings applies to portfolio.','initlanesis' ) ?></span></p>
...
function zpsettings_responsive_logo_settings() { ?>
    ...
    <h4><?php _e( '600 Max Width Logo', 'initlanesis' ); ?></h4>


    <p><label for="<?php echo ZP_SETTINGS_FIELD; ?>[zp_600_logo]"><?php _e( 'Upload Custom Logo.', 'initlanesis' ); ?></label>
    ...
    <input id="<?php echo ZP_SETTINGS_FIELD; ?>[zp_600_logo_upload_button]" name="<?php echo ZP_SETTINGS_FIELD; ?>[zp_600_logo_upload_button]" type="button" class="logo_button button" value="<?php _e( 'Upload Logo', 'initlanesis' ); ?>" />
    ...
    <p><label for="<?php echo ZP_SETTINGS_FIELD; ?>[zp_600_logo_width]"><?php _e( 'Custom Logo Width in pixel/percentage.', 'initlanesis' ); ?></label>
    ...
    <p><label for="<?php echo ZP_SETTINGS_FIELD; ?>[zp_600_logo_height]"><?php _e( 'Custom Logo Height in pixel/percentage.', 'initlanesis' ); ?></label>
	...
	<p> <label for="<?php echo ZP_SETTINGS_FIELD; ?>[zp_600_background_pos]"><?php _e( 'Select Background Position.','initlanesis'); ?></label>
    ...
    <h4><?php _e( '480 Max Width Logo', 'initlanesis' ); ?></h4>

    <p><label for="<?php echo ZP_SETTINGS_FIELD; ?>[zp_480_logo]"><?php _e( 'Upload Custom Logo.', 'initlanesis' ); ?></label>
    ...
    <input id="<?php echo ZP_SETTINGS_FIELD; ?>[zp_480_logo_upload_button]" name="<?php echo ZP_SETTINGS_FIELD; ?>[zp_480_logo_upload_button]" type="button" class="logo_button button" value="<?php _e( 'Upload Logo', 'initlanesis' ); ?>" />
    ...
    <p><label for="<?php echo ZP_SETTINGS_FIELD; ?>[zp_480_logo_width]"><?php _e( 'Custom Logo Width in pixel/percentage.', 'initlanesis' ); ?></label>
    ...
    <p><label for="<?php echo ZP_SETTINGS_FIELD; ?>[zp_480_logo_height]"><?php _e( 'Custom Logo Height in pixel/percentage.', 'initlanesis' ); ?></label>
	...
	<p> <label for="<?php echo ZP_SETTINGS_FIELD; ?>[zp_480_background_pos]"><?php _e( 'Select Background Position.','initlanesis'); ?></label>
    ...
    <h4><?php _e( '320 Max Width Logo', 'initlanesis' ); ?></h4>

    <p><label for="<?php echo ZP_SETTINGS_FIELD; ?>[zp_320_logo]"><?php _e( 'Upload Custom Logo.', 'initlanesis' ); ?></label>
    ...
    <input id="<?php echo ZP_SETTINGS_FIELD; ?>[zp_320_logo_upload_button]" name="<?php echo ZP_SETTINGS_FIELD; ?>[zp_320_logo_upload_button]" type="button" class="logo_button button" value="<?php _e( 'Upload Logo', 'initlanesis' ); ?>" />
    ...
    <p><label for="<?php echo ZP_SETTINGS_FIELD; ?>[zp_320_logo_width]"><?php _e( 'Custom Logo Width in pixel/percentage.', 'initlanesis' ); ?></label>
    ...
    <p><label for="<?php echo ZP_SETTINGS_FIELD; ?>[zp_320_logo_height]"><?php _e( 'Custom Logo Height in pixel/percentage. ', 'initlanesis' ); ?></label>
    ...
    <p> <label for="<?php echo ZP_SETTINGS_FIELD; ?>[zp_320_background_pos]"><?php _e( 'Select Background Position.','initlanesis'); ?></label>
...
function zp_replace_thickbox_text($translated_text, $text ) {
	...
	if ( 'Insert into Post' == $text ) {
		...
		if ( $referer != '' ) {
			...
			return __('Insert Image!', 'initlanesis' );
...
function zpsettings_theme_options_page() {
	...
	<div id="zpsettings" class="wrap genesis-metaboxes">
		<form method="post" action="options.php">
			...
			<h2>
				<?php _e( 'initlanesis Settings', 'initlanesis' ); ?>
                <input type="submit" class="button-primary genesis-h2-button" value="<?php _e( 'Save Settings', 'initlanesis' ) ?>" />
                <input type="submit" class="button genesis-h2-button" name="<?php echo ZP_SETTINGS_FIELD; ?>[reset]" value="<?php _e( 'Reset Settings', 'initlanesis' ); ?>" onclick="return genesis_confirm('<?php echo esc_js( __( 'Are you sure you want to reset?', 'initlanesis' ) ); ?>');" />
            </h2>
		...
		<?php if(($latest_version !== false) && ($latest_version > ZP_THEME_VERSION)): ?>
        	...
        	<div class="updated" id="message">
                ...
                <p>View changelog for more details <a href="http://demo.zigzagpress.com/initlanesis/changelog.txt" target="_blank">here</a>.</p>
